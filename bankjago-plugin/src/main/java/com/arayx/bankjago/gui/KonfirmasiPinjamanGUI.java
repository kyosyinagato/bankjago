...
public class KonfirmasiPinjamanGUI {

    private final BankJago plugin;
    private final MessageManager msg;

    public KonfirmasiPinjamanGUI(BankJago plugin, MessageManager msg) {
        this.plugin = plugin;
        this.msg = msg;
    }

    public void open(Player player, String rekap) {
        Inventory inv = Bukkit.createInventory(null, 27, msg.get("pinjaman_konfirmasi_title"));
